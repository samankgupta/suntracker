...
const DataSet = () => {
  return (
    <div className="container">
      <div className="row">
        <div className="box-1 col-12 my-4">
          <Graph1 className="Graph1"></Graph1>
        </div>
        <div className="box-2 col-12 col-md-7 my-4">
        ...
        <div className="box-2 col-12 col-md-4 my-4">
          <img src={luminosityImage} className="lumiImg"/>
          <Graph4 className="Graph4"></Graph4>
        </div>
        <div className="box-2 col-12 offset-md-1 col-md-7 my-4">
